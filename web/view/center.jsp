  ...
  <header>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-50">
            <h4 class="card-header" style="font-family: 'Nanum Gothic Coding', monospace;">빅데이터 분석 분석가</h4>
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-50">
            <h4 class="card-header" style="font-family: 'Nanum Gothic Coding', monospace;">IOT 개발 전문가</h4>
            <div class="card-body">
